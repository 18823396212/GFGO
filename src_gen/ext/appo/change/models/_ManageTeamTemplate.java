...
public abstract class _ManageTeamTemplate extends wt.fc.WTObject implements java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "ext.appo.change.models.modelsResource";
   static final java.lang.String CLASSNAME = ManageTeamTemplate.class.getName();

   /**
    * 模板ID
    *
    * @see ext.appo.change.models.ManageTeamTemplate
    */
    ...
    * @see ext.appo.change.models.ManageTeamTemplate
    */
   public static final java.lang.String SHARE_TEMPLATE = "shareTemplate";
   static int SHARE_TEMPLATE_UPPER_LIMIT = -1;
   java.lang.String shareTemplate;
   /**
    * 共享
    *
    * @see ext.appo.change.models.ManageTeamTemplate
    */
   public java.lang.String getShareTemplate() {
    ...
    * @see ext.appo.change.models.ManageTeamTemplate
    */
   public void setShareTemplate(java.lang.String shareTemplate) throws wt.util.WTPropertyVetoException {
      shareTemplateValidate(shareTemplate);
      this.shareTemplate = shareTemplate;
   }
   void shareTemplateValidate(java.lang.String shareTemplate) throws wt.util.WTPropertyVetoException {
      if (SHARE_TEMPLATE_UPPER_LIMIT < 1) {
         try { SHARE_TEMPLATE_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("shareTemplate").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { SHARE_TEMPLATE_UPPER_LIMIT = 200; }
      }
      if (shareTemplate != null && !wt.fc.PersistenceHelper.checkStoredLength(shareTemplate.toString(), SHARE_TEMPLATE_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "shareTemplate"), java.lang.String.valueOf(java.lang.Math.min(SHARE_TEMPLATE_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "shareTemplate", this.shareTemplate, shareTemplate));
   }
   ...
   public static final long EXTERNALIZATION_VERSION_UID = 5236054564990322016L;
   ...
   public void writeExternal(java.io.ObjectOutput output) throws java.io.IOException {
      ...
      output.writeObject( shareTemplate );
   ...
   protected void super_writeExternal_ManageTeamTemplate(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (ext.appo.change.models.ManageTeamTemplate) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_ManageTeamTemplate(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   public void writeExternal(wt.pds.PersistentStoreIfc output) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      output.setString( "shareTemplate", shareTemplate );
   ...
   public void readExternal(wt.pds.PersistentRetrieveIfc input) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      shareTemplate = input.getString( "shareTemplate" );
   ...
   boolean readVersion5236054564990322016L( java.io.ObjectInput input, long readSerialVersionUID, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      if ( !superDone )
         super.readExternal( input );

      saveUser = (wt.fc.ObjectReference) input.readObject();
      shareTemplate = (java.lang.String) input.readObject();
   ...
   protected boolean readVersion( ManageTeamTemplate thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      boolean success = true;

      if ( readSerialVersionUID == EXTERNALIZATION_VERSION_UID )
         return readVersion5236054564990322016L( input, readSerialVersionUID, superDone );
      else
   ...
   protected boolean super_readVersion_ManageTeamTemplate( _ManageTeamTemplate thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {

...
public class SQLInfoUtil {

	public static String tomcatClassPath = SQLInfoUtil.class.getClassLoader().getResource("").getPath().replaceAll("%20", " ");
	...
	static{
		p= new Properties();
		try {
			p.load(new FileInputStream(filePath+"/SQLServer.properties"));

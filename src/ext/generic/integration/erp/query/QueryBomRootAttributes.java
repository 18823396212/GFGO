 ...
 * @author Kwang
 */
public class QueryBomRootAttributes extends QueryIETask {
	
	private static final Logger logger = LogR.getLogger(QueryBomRootAttributes.class.getName() );
	
	public static final String CONFIG_XML_FILE = "QueryBomRootAttribute.xml" ;
	
	private static String table = "" ;
	
	public QueryBomRootAttributes(){
		super();
	...
	public static List<GenericIEBean> queryPart( String number ){
		...
		QueryIETask queryIETask = new QueryBomRootAttributes() ;
	...
	public static List< String > getQueryAttributes(){
		...
		String url = CommonPDMUtil.getCodebasePath() + "ext/generic/integration/erp/config/QueryBomRootAttribute.xml";

 ...
 * @author Kwang
 */
public class QueryECNAttributes extends QueryIETask {
	
	private static final Logger logger = LogR.getLogger(QueryECNAttributes.class.getName() );
	
	public static final String CONFIG_XML_FILE = "QueryECNAttribute.xml" ;
	
	private static String table = "" ;
	
	public QueryECNAttributes(){
		super();
	 ...
	 * @return
	 */
	public static List<GenericIEBean> queryECN( String number ){
		logger.debug("Entering In QueryPartReleaseAttributes.queryPart( String number )......") ;
		...
		QueryIETask queryIETask = new QueryECNAttributes() ;
	...
	public static List< String > getQueryAttributes(){
		...
		String url = CommonPDMUtil.getCodebasePath() + "ext/generic/integration/erp/config/QueryECNAttribute.xml";

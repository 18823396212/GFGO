                    ...
                    for (String oid : map.keySet()) {
                        ...
                        if (oid.equals(CONSTANTS_7)) {
                            ...
                            if (persistable instanceof TransactionTask) {
                                ...
                                String changeDescribe = attributeMap.get(CHANGEDESCRIBE_COMPID) == null ? task.getChangeTheme() : attributeMap.get(CHANGEDESCRIBE_COMPID);
                                String responsible = attributeMap.get(RESPONSIBLE_COMPID) == null ? task.getChangeTheme() : attributeMap.get(RESPONSIBLE_COMPID);
                                String needDate = attributeMap.get(NEEDDATE_COMPID) == null ? task.getChangeTheme() : attributeMap.get(NEEDDATE_COMPID);

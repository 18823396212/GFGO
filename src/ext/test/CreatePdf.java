...
public class CreatePdf {
    ...
    public <T> void generatePDF(WTChangeOrder2 eco) throws WTException, DocumentException, ParseException {
        ...
        //add by lzy at 20200428 start
        String[] headProduct = {"名称", "编号", "版本", "状态", "规格描述", "处理方式"};
        //add by lzy at 20200428 end
//		String[] headProduct = { "名称", "编号", "版本", "状态", "规格描述" };
        String tasks = "事务性任务";
		//add by lzy at 20200428 start
		String[] headTasks = {"任务类型","任务主题", "管理方式","任务描述","期望完成时间","责任人","状态","任务单号","实际完成时间"};
		//add by lzy at 20200428 end
//        String[] headTasks = {"任务主题", "任务描述", "期望完成时间", "责任人"};
        ...
        for (AffectedProductBean affectedProductBean : listAffProductBean) {
            ...
            String[] affectedProduct = {affectedProductBean.getName(), affectedProductBean.getNumber(),
                    affectedProductBean.getVersion(), affectedProductBean.getState(), affectedProductBean.getGGSM(), affectedProductBean.getCLFS()};
...
//					affectedProductBean.getVersion(), affectedProductBean.getState(), affectedProductBean.getGGSM() };
        ...
        //add by lzy at 20200402 start
        float[] wid9 = {0.20f, 0.12f, 0.08f, 0.08f, 0.32f, 0.20f}; // 两列宽度的比例
        //add by lzy at 20200402 end
//		float[] wid9 = { 0.25f, 0.15f, 0.10f, 0.10f, 0.40f }; // 两列宽度的比例
        ...
        for (int i = 0; i < listSwxrw.size(); i++) {
            ...
            //add by lzy at 20200428 start
            String[] swxrw = {map.get("taskType"),map.get("taskTitle"),map.get("taskStyle"),  map.get("taskDesc"),
                    map.get("taskEndTime"),map.get("taskPersion"),map.get("taskState"),map.get("taskNumber"),map.get("taskActualDate")};
            //add by lzy at 202004028 end
...
//                    map.get("taskPersion")};
        ...
        float[] wid11 = {0.10f,0.10f, 0.10f,0.20f, 0.12f, 0.10f,0.06f,0.10f,0.12f}; // 两列宽度的比例

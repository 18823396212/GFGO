...
@ComponentBuilder("ext.appo.ecn.mvc.builder.AffectedUpperMaterialsTableBuilder")
public class AffectedUpperMaterialsTableBuilder extends AbstractComponentBuilder{
	
	private static final String TABLE_ID = "ext.appo.ecn.mvc.builder.AffectedUpperMaterialsTableBuilder";
	
	private static final String CLASSNAME = AffectedUpperMaterialsTableBuilder.class.getName() ;
	...
	public Object buildComponentData(ComponentConfig config, ComponentParams params) throws Exception {
		...
		try {
			...
			if (pbo instanceof WTChangeOrder2) {
				...
				datasArray = AffectedMaterialsUtil.getBuilderDateValue(ecn,"1");
			}
		}catch (Exception e) {

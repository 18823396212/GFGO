...
public class MversionControlHelper {
    ...
    public static WTPartUsageLink getUsageLink(WTPart theWTPart, WTPartMaster theWTPartMaster) throws WTException {
        ...
        qs.appendWhere(new SearchCondition(WTPartUsageLink.class, ObjectToObjectLink.ROLE_AOBJECT_REF + "." + ObjectReference.KEY + "." + ObjectIdentifier.ID, SearchCondition.EQUAL, PersistenceHelper.getObjectIdentifier(theWTPart).getId()), fromIndicies);
        qs.appendAnd();
        qs.appendWhere(new SearchCondition(WTPartUsageLink.class, ObjectToObjectLink.ROLE_BOBJECT_REF + "." + ObjectReference.KEY + "." + ObjectIdentifier.ID, SearchCondition.EQUAL, PersistenceHelper.getObjectIdentifier(theWTPartMaster).getId()), fromIndicies);
    ...
    public static void buildEffectiveChild(WfProcess process, WTPart top, String upUID, List<EffectiveBaselineBean> beans) throws WTException {
        try {
    ...
    // 获取所有的bean
    public static List<EffectiveBaselineBean> buildAllEffectiveParts(WfProcess process, Set<WTPart> parts) throws WTException {
    ...
    public static Map<String, String> buildAffectedValue(WTPart parent, WTPart child) throws WTException {
        ...
        map.put("parentVersion", parent.getVersionIdentifier().getValue() + "." + parent.getIterationIdentifier().getValue());
        ...
        map.put("childVersion", child.getVersionIdentifier().getValue() + "." + child.getIterationIdentifier().getValue());
    ...
    public static Map<String, String> buildAffectedValueByChild(WTPart parent, WTPart child, WTPartUsageLink link) throws WTException {
        Map<String, String> map = new HashMap<>();
        if (link == null) {
            return map;
        }

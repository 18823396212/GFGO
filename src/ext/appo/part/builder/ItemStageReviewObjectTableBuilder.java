 ...
 * @author Yzhang
 */
@ComponentBuilder("ext.appo.part.builder.ItemStageReviewObjectTableBuilder")
public class ItemStageReviewObjectTableBuilder extends AbstractComponentBuilder {
	private ClientMessageSource msgSource = getMessageSource(
			"ext.generic.reviewObject.resource.ReviewObjectResourceRB");
	private static final Logger LOGGER = LogR.getLogger(ItemStageReviewObjectTableBuilder.class.getName());

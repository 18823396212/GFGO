...
public class FileAttachListYLBean {
     	...
     	public FileAttachListYLBean(String fileID, String attachName, String guidName, String extensionName, String uerNo,
    			String fileSize) {
    		super();
    		this.fileID = fileID;
    		this.attachName = attachName;

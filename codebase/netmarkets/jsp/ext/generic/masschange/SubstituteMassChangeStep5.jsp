...
<%
	...
	String SUBSTITUTE_MASSCHANGE_TYPE_LOCAL = resource.getString(MassChangeResource.MASSCHANGE_REMOVE_SUBSTITUTE);
...
<script type="text/javascript">
  ...
  function searchUseageLink () {	
  	document.cookie = "SUBSTITUTE_MASSCHANGE_TYPE=" + "MASSCHANGE_REMOVE_SUBSTITUTE";

...
<%@ page import="ext.appo.change.util.ECAReviewActivityUtil,ext.generic.reviewprincipal.util.ReviewPrincipalUtil,wt.fc.Persistable,wt.fc.WTObject" %>
<%@ page import="wt.project.Role,wt.session.SessionServerHelper,wt.workflow.engine.WfActivity,wt.workflow.engine.WfProcess" %>
...
<%
    ...
    try {
        ...
        if (contextNmOid != null) {
            ...
            // 获取所有活动
            String setactive = "";
            Hashtable<String, String> table = ECAReviewActivityUtil.getAugumentTable((WTObject) pbo, null, wfprocess);
            if (table != null) {
...
<jca:renderPropertyPanel>
    <w:comboBox id="rolecomb" propertyLabel="${roleStrvar}" name="rolecomb" size="1" required="true" multiSelect="false"
                internalValues="${arrayvalue}" displayValues="${arraydisp}" onchange="changeDepart(this);"/>
</jca:renderPropertyPanel>

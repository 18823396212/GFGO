...
<%
	...
	if ("delete".equals(type)){
		teamTemplateBeans=TeamTemplateUtil.getTeamTemplateInfosLimitDelete(oid);
	} else if ("apply".equals(type)) {
		teamTemplateBeans=TeamTemplateUtil.getTeamTemplateInfosLimitShow(oid);
	}
...
//	Map<String,String> buMap = WFTeamTemplateUtil.getPboTemplates(oid);
	...
	for (TeamTemplateBean teamTemplateBean:teamTemplateBeans) {
		buKeys.add(teamTemplateBean.getTemplateOid());
		buNames.add(teamTemplateBean.getTemplateName());
	}

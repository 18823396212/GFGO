...
<%
    ...
    System.out.println("taskCheckbox==" + taskCheckbox);
    System.out.println("taskCheckboxs==" + taskCheckboxs);
    System.out.println("ecn==" + ecnNumber);
    ...
    if (ecnNumber != null && taskCheckboxs != null && taskCheckboxs.size() > 0) {
        ...
        try {
            TransactionECAUtil.startupTask(ecn, ChangeTaskInfoBeans);
        } finally {

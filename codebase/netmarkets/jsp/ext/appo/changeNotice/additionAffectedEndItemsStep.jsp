...
<%
	...
	if(objecttypelist!=null&&objecttypelist.size()>0) 
		tyepvaluedefault = (String)objecttypelist.get(0);
...
<table >
  ...
  <tr>
    ...
    <jca:renderPropertyPanel>
    	    <w:comboBox id="objecttype" name="objecttype"  internalValues="${objecttpyevalue}"  displayValues="${objecttypedisplay}" multiSelect="false" selectedValues="${typedefault}"/>
   </jca:renderPropertyPanel>
    </td><td></td>
  </tr>
...
<jca:describeTable var="searchBorrowObjectTableDescriptor" 
   ...
   <jca:describeColumn id="borroworder_containername" label="${contextLabel}" dataUtilityId="borroworder_containername"/>
...
<script>
	...
	function affectedEndItemsBySearch(){
        ...
        window.opener.addCollectItemsForAffectedEndItems(itemsOid,"additionAffectedEndItems") ;

...
<table border="0">
	<tr>
		<td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td align="right" nowrap="nowrap"><strong>*请选择文件(Excel)：</strong><input type="file" name="txtFile" id="txtFile" size="40" /></td>
		<td nowrap="nowrap">&nbsp;</td>
		<td nowrap="nowrap"><br><a style="color:red" href='/Windchill/netmarkets/jsp/ext/appo/part/addrole.xls' target='_blank'>点击此处下载模板文件</a></td>
	</tr>
</table>
